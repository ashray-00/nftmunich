...
const copy = {
  de: {
    ...
    player: "Registrierter Spieler",
    playerText: "Nur für Spieler mit einer bereits freigegebenen E-Mail-Adresse.",
    playerFee: "10 € Mitgliedsbeitrag + 55 € Studierende/Azubis oder 100 € sonstige Spieler",
    management: "Management + Spieler",
    managementText: "Für freigegebene Personen, die spielen und zugleich eine Vereinsaufgabe übernehmen.",
    managementFee: "Spielerbeitrag entsprechend der persönlichen Kategorie",
    choose: "Auswählen",
  ...
  en: {
    ...
    playerFee: "€10 membership + €55 for students/trainees or €100 for other players",
    management: "Management + player",
    managementText: "For approved people who play and also hold a club responsibility.",
    managementFee: "Player fee according to the applicable personal category",
    choose: "Select",
